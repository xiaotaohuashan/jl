...
public class ArrowRefreshHeader extends LinearLayout implements BaseRefreshHeader {
    ...
    private boolean needAnim = true; //是否需要旋转动画
    ...
    private void initView() {
        ...
        refreshTip = new String[]{getResources().getString(R.string.listview_header_hint_normal),
                getResources().getString(R.string.listview_header_hint_release),
                getResources().getString(R.string.refreshing),
                getResources().getString(R.string.refresh_done)};
    }

    public void setRefreshTip(String[] refreshTip) {
        this.refreshTip = refreshTip;
        mStatusTextView.setText(refreshTip[0]);
    }
        ...
        switch (state) {
            ...
            case STATE_RELEASE_TO_REFRESH:
                if (mState != STATE_RELEASE_TO_REFRESH) {
                    ...
                    mStatusTextView.setText(refreshTip[1]);
                }
                break;
            case STATE_REFRESHING:
                mStatusTextView.setText(refreshTip[2]);
                break;
            case STATE_DONE:
                mStatusTextView.setText(refreshTip[3]);
                break;
            default:
        }
